...
final class SIMDEndianBytesTests: XCTestCase {
    func testSIMDBigEndian() {
        ...
        XCTAssertEqual(SIMD2<UInt16>(0x0123, 0x4567).bigEndianBytes(),
                       Array(SIMD2<UInt16>(0x0123, 0x4567).bigEndianBytes()))
    }
    ...
    func testSIMDLittleEndian() {
        ...
        XCTAssertEqual(SIMD2<UInt16>(0x0123, 0x4567).littleEndianBytes(),
                       Array(SIMD2<UInt16>(0x0123, 0x4567).littleEndianBytes()))
    }
